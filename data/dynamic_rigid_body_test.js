...
var DynamicRigidBodyTest = (function (_super) {
    __extends(DynamicRigidBodyTest, _super);
    function DynamicRigidBodyTest(geometry, material, renderer) {
        ...
        this.velocity = math.transpose(math.matrix([4, 20, 7, 6, 0, 0]));
        this.state = math.transpose(math.matrix([0, 0, 0, 0, 0, Math.PI / 4]));
        //renderer.scene.add(this.object);
    }
    DynamicRigidBodyTest.prototype.update = function (time, delta) {
    ...
    DynamicRigidBodyTest.prototype.rotateMatrix = function (rotateStart, rotateEnd) {
    ...
    DynamicRigidBodyTest.prototype.collision = function (collision) {
    ...
    DynamicRigidBodyTest.prototype.friction = function (collision) {
        var force_radius = math.matrix([collision[0], collision[1], collision[2]]);
        var normal = math.matrix([collision[3], collision[4], collision[5]]);
        var J = math.matrix([
    ...
    DynamicRigidBodyTest.prototype.calculateInertiaTensor = function () {
        var dV = 0.1 * 0.1;
        var Ixx = 0;
    ...
    Object.defineProperty(DynamicRigidBodyTest.prototype, "frictionConst", {
        get: function () {
    ...
    return DynamicRigidBodyTest;
})(PhysicsObject3d);
//# sourceMappingURL=dynamic_rigid_body_test.js.map