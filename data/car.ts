...
class Car extends VehicleSetup {
    constructor(renderer : Renderer, vehicle : Vehicle){
        ...
        vehicle.vehicleModel.addCollisionPoint(this.wheels[0].object.position.clone().add(new Vector3(0,2.5,0)));
        vehicle.vehicleModel.addCollisionPoint(this.wheels[1].object.position.clone().add(new Vector3(0,2.5,0)));
        vehicle.vehicleModel.addCollisionPoint(this.wheels[2].object.position.clone().add(new Vector3(0,2.5,0)));
        vehicle.vehicleModel.addCollisionPoint(this.wheels[3].object.position.clone().add(new Vector3(0,2.5,0)));
        ...
        this.springConnector = [
            ...
            new SpringConnector(
                ...
                this.wheels[2],
                this.vehicleBody,
                this.wheels[2].object.position.clone().add(new THREE.Vector3(2.5,2,0)),
                this.wheels[2].object.position.clone().add(new THREE.Vector3(0.5,0,0))
            ),
            new SpringConnector(
                renderer,
                vehicle.vehicleModel,
                this.wheels[3],
                this.vehicleBody,
                this.wheels[3].object.position.clone().add(new THREE.Vector3(-2.5,2,0)),
                this.wheels[3].object.position.clone().add(new THREE.Vector3(-0.5,0,0))
            ),
        ];
